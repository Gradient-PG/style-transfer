...
from diffusers.pipelines.controlnet import StableDiffusionControlNetImg2ImgPipeline, StableDiffusionControlNetPipeline
...
@torch.no_grad()
def func_call_controlnet_pipeline(
		self,
		prompt: Union[str, List[str]] = None,
		image: Union[
			torch.FloatTensor,
...
StableDiffusionControlNetPipeline.__call__ = func_call_controlnet_pipeline
